...
abstract class AppLocalizations {
  ...
  String get receiveCampaignUpdates;
  ...
  /// No description provided for @aboutKindora.
  ///
  /// In en, this message translates to:
  /// **'About Kindora'**
  String get aboutKindora;
  ...
  /// No description provided for @activeDonorSince.
  ///
  /// In en, this message translates to:
  /// **'Active Donor Since 2024'**
  String get activeDonorSince;

  /// No description provided for @verifiedHumanitarian.
  ///
  /// In en, this message translates to:
  /// **'Verified Humanitarian'**
  String get verifiedHumanitarian;
  ...
  /// No description provided for @campaignsSupported.
  ///
  /// In en, this message translates to:
  /// **'Campaigns Supported'**
