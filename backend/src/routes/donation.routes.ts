...
router.post('/card/create-intent', authenticateToken, DonationController.createCardPaymentIntent);
router.post('/card/confirm-payment', authenticateToken, DonationController.confirmCardPayment);
router.post('/card/cancel-payment', authenticateToken, DonationController.cancelCardPayment);
