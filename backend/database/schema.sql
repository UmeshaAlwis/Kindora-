...
-- ============================================
-- 2b. CAMPAIGN_VOLUNTEERS TABLE
-- ============================================
-- Stores volunteers that joined donor campaigns requiring volunteers.
...
CREATE INDEX IF NOT EXISTS idx_campaign_volunteers_campaign_id ON campaign_volunteers (campaign_id);
CREATE INDEX IF NOT EXISTS idx_campaign_volunteers_user_id ON campaign_volunteers (user_id);

-- ============================================
-- 2c. MERCHANDISE TABLE (Admin Merchandise)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_merchandise_active ON merchandise (is_active);

-- ============================================
-- 2d. MERCHANDISE_ORDERS TABLE
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_merchandise_orders_merchandise_id ON merchandise_orders (merchandise_id);
